...
const events = [
  {
    ...
    writeup:
      "Looking for like-minded peers who are also trying to up their technical interview skills? Look no further! CodingPrep is a weekly meet where we spend half the time doing LeetCode problems, and the other half explaining solutions in mini groups.",
